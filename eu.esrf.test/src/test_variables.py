#!/usr/bin/python2.6 
import os,shutil 
queue = {'suite_usecases_general':{'tst_case':'tst_hdf5_large_tree'}}
...
for testSuiteName in queue.keys(): 
	...
	print '***************************'
	print (os.path.join(os.environ['WORKSPACE'],'eu.esrf.test/src')) 
	print ("./script_jenkins "+testSuiteName+" "+queue[testSuiteName][tst])
